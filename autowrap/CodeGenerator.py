...
class CodeGenerator(object):
    ...
    def create_wrapper_for_method(self, decl, name, methods):
        if len(methods) == 1:
            self.create_wrapper_for_nonoverloaded_method(decl, name,
                    methods[0])
    ...
    def create_wrapper_for_nonoverloaded_method(self, decl, name, method):
